        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                _buildTestChip('Panchang Today', () => AstroApiService.getTodayPanchang()),
                _buildTestChip('Shubh Muhurta', () => AstroApiService.getMuhurta()),
                _buildTestChip('Janam Kundli', () => AstroApiService.getSampleKundli()),
                _buildTestChip('36 Guna Milan', () => AstroApiService.getSampleMatch()),
                _buildTestChip('Daily Transits', () => AstroApiService.getDailyTransits()),
                _buildTestChip('Ephemeris', () => AstroApiService.getEphemeris()),
                _buildTestChip('Ayanamsa List', () => AstroApiService.getAyanamsa()),
