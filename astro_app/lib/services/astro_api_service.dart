...
class AstroApiService {
  ...
  static Map<String, dynamic> _fallbackKundli(String name, String dob, String tob, String pob) {
    return {
      ...
      'planets': [
        {'name': 'Ascendant (Lagna)', 'planet_name_simple': 'Ascendant', 'sign': 'Aquarius', 'sign_index': 11, 'house': 1, 'degree_formatted': '03:35:00', 'nakshatra': 'Dhanishta', 'pada': 4, 'is_retrograde': false, 'status_marker': '', 'color': '#8B5CF6'},
        {'name': 'Sun (AmK)', 'planet_name_simple': 'Sun', 'sign': 'Cancer', 'sign_index': 4, 'house': 6, 'degree_formatted': '21:49:12', 'nakshatra': 'Ashlesha', 'pada': 2, 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'AmK', 'color': '#EA580C'},
        {'name': 'Moon (AK)', 'planet_name_simple': 'Moon', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '24:49:33', 'nakshatra': 'Purva Phalguni', 'pada': 4, 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'AK', 'color': '#3B82F6'},
        {'name': 'Mars (DK)', 'planet_name_simple': 'Mars', 'sign': 'Taurus', 'sign_index': 2, 'house': 4, 'degree_formatted': '03:55:20', 'nakshatra': 'Krittika', 'pada': 3, 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'DK', 'color': '#DC2626'},
        {'name': 'Mercury (GK)', 'planet_name_simple': 'Mercury', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '04:04:15', 'nakshatra': 'Magha', 'pada': 2, 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'GK', 'color': '#16A34A'},
        {'name': 'Jupiter (MK)', 'planet_name_simple': 'Jupiter', 'sign': 'Taurus', 'sign_index': 2, 'house': 4, 'degree_formatted': '14:24:08', 'nakshatra': 'Rohini', 'pada': 2, 'is_retrograde': false, 'status_marker': '(C)', 'is_combust': true, 'chara_karaka_code': 'MK', 'color': '#D97706'},
        {'name': 'Venus (PK)', 'planet_name_simple': 'Venus', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '07:33:45', 'nakshatra': 'Magha', 'pada': 3, 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'PK', 'color': '#EC4899'},
        {'name': 'Saturn (BK)', 'planet_name_simple': 'Saturn', 'sign': 'Pisces', 'sign_index': 12, 'house': 2, 'degree_formatted': '20:22:11', 'nakshatra': 'Revati', 'pada': 2, 'is_retrograde': true, 'status_marker': '(R)', 'chara_karaka_code': 'BK', 'color': '#6366F1'},
        {'name': 'Rahu', 'planet_name_simple': 'Rahu', 'sign': 'Aquarius', 'sign_index': 11, 'house': 1, 'degree_formatted': '06:18:40', 'nakshatra': 'Shatabhisha', 'pada': 1, 'is_retrograde': true, 'status_marker': '(R)', 'color': '#8B5CF6'},
        {'name': 'Ketu', 'planet_name_simple': 'Ketu', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '06:18:40', 'nakshatra': 'Magha', 'pada': 3, 'is_retrograde': true, 'status_marker': '(R)', 'color': '#78716C'},
      ],
      'upagrahas': [
      ...
      'arudha_padas': [
        {'code': 'AL (A1)', 'name': 'Arudha Lagna (आरूढ़ लग्न)', 'house_number': 1, 'sign': 'Aquarius', 'sign_sanskrit': 'Kumbha', 'sign_index': 11, 'degree_formatted': '03:35:00', 'nakshatra': 'Dhanishta', 'pada': 4, 'significance': 'Image, Public Status & Manifested Self'},
        {'code': 'A2', 'name': 'Dhana Pada (धन पद)', 'house_number': 2, 'sign': 'Pisces', 'sign_sanskrit': 'Meena', 'sign_index': 12, 'degree_formatted': '20:22:11', 'nakshatra': 'Revati', 'pada': 2, 'significance': 'Wealth, Financial Assets & Family Resources'},
        {'code': 'A3', 'name': 'Bhratri Pada (भ्रातृ पद)', 'house_number': 3, 'sign': 'Aries', 'sign_sanskrit': 'Mesha', 'sign_index': 1, 'degree_formatted': '03:55:20', 'nakshatra': 'Krittika', 'pada': 3, 'significance': 'Siblings, Courage & Enterprise'},
        {'code': 'A4', 'name': 'Matri / Sukha Pada (मातृ पद)', 'house_number': 4, 'sign': 'Taurus', 'sign_sanskrit': 'Vrishabha', 'sign_index': 2, 'degree_formatted': '07:33:45', 'nakshatra': 'Krittika', 'pada': 4, 'significance': 'Home, Vehicles & Inner Comforts'},
        {'code': 'A5', 'name': 'Putra / Mantra Pada (पुत्र पद)', 'house_number': 5, 'sign': 'Gemini', 'sign_sanskrit': 'Mithuna', 'sign_index': 3, 'degree_formatted': '04:04:15', 'nakshatra': 'Mrigashira', 'pada': 4, 'significance': 'Progeny, Creativity & Intelligence'},
        {'code': 'A6', 'name': 'Shatru / Roga Pada (शत्रु पद)', 'house_number': 6, 'sign': 'Cancer', 'sign_sanskrit': 'Karka', 'sign_index': 4, 'degree_formatted': '24:49:33', 'nakshatra': 'Ashlesha', 'pada': 3, 'significance': 'Debts, Diseases & Competition'},
        {'code': 'A7', 'name': 'Dara Pada (दार पद)', 'house_number': 7, 'sign': 'Leo', 'sign_sanskrit': 'Simha', 'sign_index': 5, 'degree_formatted': '07:33:45', 'nakshatra': 'Magha', 'pada': 3, 'significance': 'Spouse, Partnerships & Trade'},
        {'code': 'A8', 'name': 'Mrityu Pada (मृत्यु पद)', 'house_number': 8, 'sign': 'Virgo', 'sign_sanskrit': 'Kanya', 'sign_index': 6, 'degree_formatted': '03:55:20', 'nakshatra': 'Uttara Phalguni', 'pada': 3, 'significance': 'Longevity & Transformation'},
        {'code': 'A9', 'name': 'Bhagya Pada (भाग्य पद)', 'house_number': 9, 'sign': 'Libra', 'sign_sanskrit': 'Tula', 'sign_index': 7, 'degree_formatted': '14:24:08', 'nakshatra': 'Swati', 'pada': 3, 'significance': 'Fortune, Dharma & Higher Wisdom'},
        {'code': 'A10', 'name': 'Rajya / Karma Pada (राज्य पद)', 'house_number': 10, 'sign': 'Scorpio', 'sign_sanskrit': 'Vrischika', 'sign_index': 8, 'degree_formatted': '20:22:11', 'nakshatra': 'Jyeshtha', 'pada': 2, 'significance': 'Career, Fame & Authority'},
        {'code': 'A11', 'name': 'Labha Pada (लाभ पद)', 'house_number': 11, 'sign': 'Sagittarius', 'sign_sanskrit': 'Dhanus', 'sign_index': 9, 'degree_formatted': '14:24:08', 'nakshatra': 'Purva Ashadha', 'pada': 1, 'significance': 'Gains & Networks'},
        {'code': 'UL (A12)', 'name': 'Upapada Lagna (उपपद लग्न)', 'house_number': 12, 'sign': 'Capricorn', 'sign_sanskrit': 'Makara', 'sign_index': 10, 'degree_formatted': '20:22:11', 'nakshatra': 'Shravana', 'pada': 4, 'significance': 'Marriage & Life Partner'},
      ],
      'special_lagnas': [
        {'name': 'Hora Lagna (HL)', 'sanskrit': 'होरा लग्न (HL)', 'sign': 'Leo', 'sign_sanskrit': 'Simha', 'sign_index': 5, 'degree_formatted': '21:10:00', 'nakshatra': 'Purva Phalguni', 'pada': 3, 'significance': 'Financial prosperity and liquid assets.'},
        {'name': 'Ghati Lagna (GL)', 'sanskrit': 'घटी लग्न (GL)', 'sign': 'Scorpio', 'sign_sanskrit': 'Vrischika', 'sign_index': 8, 'degree_formatted': '08:45:00', 'nakshatra': 'Anuradha', 'pada': 2, 'significance': 'Power, authority and public renown.'},
        {'name': 'Bhava Lagna (BL)', 'sanskrit': 'भाव लग्न (BL)', 'sign': 'Cancer', 'sign_sanskrit': 'Karka', 'sign_index': 4, 'degree_formatted': '12:15:00', 'nakshatra': 'Pushya', 'pada': 3, 'significance': 'Vitality and physical strength.'},
        {'name': 'Sree Lagna (SL)', 'sanskrit': 'श्री लग्न (SL)', 'sign': 'Taurus', 'sign_sanskrit': 'Vrishabha', 'sign_index': 2, 'degree_formatted': '18:50:00', 'nakshatra': 'Rohini', 'pada': 3, 'significance': 'Goddess Lakshmi grace and sustained wealth.'},
        {'name': 'Indu Lagna (IL)', 'sanskrit': 'इन्दु लग्न (IL)', 'sign': 'Aries', 'sign_sanskrit': 'Mesha', 'sign_index': 1, 'degree_formatted': '15:20:00', 'nakshatra': 'Bharani', 'pada': 1, 'significance': 'Financial windfalls and business prosperity.'},
      ],
      'chara_karakas': [
        {'planet': 'Moon', 'karaka_code': 'AK', 'karaka_name': 'Atmakaraka (आत्मकारक)', 'significance': 'Soul / Destiny / King', 'degree_in_sign': '24:49:33', 'sign': 'Leo', 'nakshatra': 'Purva Phalguni', 'pada': 4},
        {'planet': 'Sun', 'karaka_code': 'AmK', 'karaka_name': 'Amatyakaraka (अमात्यकारक)', 'significance': 'Career / Profession / Minister', 'degree_in_sign': '21:49:12', 'sign': 'Cancer', 'nakshatra': 'Ashlesha', 'pada': 2},
        {'planet': 'Saturn', 'karaka_code': 'BK', 'karaka_name': 'Bhratrikaraka (भ्रातृकारक)', 'significance': 'Siblings / Courage / Guru', 'degree_in_sign': '20:22:11', 'sign': 'Pisces', 'nakshatra': 'Revati', 'pada': 2},
        {'planet': 'Jupiter', 'karaka_code': 'MK', 'karaka_name': 'Matrikaraka (मातृकारक)', 'significance': 'Mother / Inner Peace / Home', 'degree_in_sign': '14:24:08', 'sign': 'Taurus', 'nakshatra': 'Rohini', 'pada': 2},
        {'planet': 'Venus', 'karaka_code': 'PK', 'karaka_name': 'Putrakaraka (पुत्रकारक)', 'significance': 'Children / Intelligence / Creativity', 'degree_in_sign': '07:33:45', 'sign': 'Leo', 'nakshatra': 'Magha', 'pada': 3},
        {'planet': 'Mercury', 'karaka_code': 'GK', 'karaka_name': 'Gnatikaraka (ज्ञातिकारक)', 'significance': 'Obstacles / Health / Competitors', 'degree_in_sign': '04:04:15', 'sign': 'Leo', 'nakshatra': 'Magha', 'pada': 2},
        {'planet': 'Mars', 'karaka_code': 'DK', 'karaka_name': 'Darakaraka (दारकारक)', 'significance': 'Spouse / Partner / Relations', 'degree_in_sign': '03:55:20', 'sign': 'Taurus', 'nakshatra': 'Krittika', 'pada': 3},
      ],
      'houses': {
        '1': ['Ascendant', 'Rahu'],
        '2': ['Saturn'],
