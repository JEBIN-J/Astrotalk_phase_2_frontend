...
class AstroApiService {
  ...
  static String get defaultBaseUrl {
    ...
    try {
      if (Platform.isAndroid) {
        ...
        return 'http://10.120.4.225:5000/api/v1';
      }
    } catch (_) {}
    return 'http://127.0.0.1:5000/api/v1';
  }
  ...
  static Map<String, dynamic> _fallbackKundli(String name, String dob, String tob, String pob) {
    return {
      ...
      'time_of_birth': tob,
      'place_of_birth': pob,
      'formatted_datetime_header': '$dob $tob',
      'latitude': 8.0883,
      'longitude': 77.5385,
      'timezone': 5.5,
      'ascendant_lagna': 'Aquarius (03° 35\' 00")',
      'ascendant_sign': 'Aquarius',
      'ascendant_sign_index': 11,
      'ascendant_sanskrit': 'Kumbha',
      'ascendant_degree': '03:35:00',
      'ascendant_degree_formatted': '03° 35\' 00"',
      'moon_sign_rashi': 'Leo (Simha)',
      'moon_sign_sanskrit': 'Simha',
      'sun_sign': 'Cancer (Karka)',
      'nakshatra': 'Uttara Phalguni',
      'nakshatra_pada': 1,
      'nakshatra_lord': 'Sun',
      'ayanamsa_formatted': "Lahiri 24° 14' 22\"",
      'planets': [
        {'name': 'Ascendant (Lagna)', 'planet_name_simple': 'Ascendant', 'display_name': 'Lagna', 'table_display_name': 'Lagna', 'sign': 'Aquarius', 'sign_index': 11, 'house': 1, 'degree_formatted': '03:35:00', 'nakshatra': 'Dhanishta', 'pada': 4, 'rl': 'Sa', 'nl': 'Ma', 'sl': 'Ra', 'ssl': 'Ve', 'is_retrograde': false, 'status_marker': '', 'color': '#8B5CF6'},
        {'name': 'Sun (AmK)', 'planet_name_simple': 'Sun', 'display_name': 'Sun', 'table_display_name': 'Sun (AmK)', 'sign': 'Cancer', 'sign_index': 4, 'house': 6, 'degree_formatted': '21:49:12', 'nakshatra': 'Ashlesha', 'pada': 2, 'rl': 'Mo', 'nl': 'Me', 'sl': 'Sa', 'ssl': 'Sa', 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'AmK', 'color': '#EA580C'},
        {'name': 'Moon (AK)', 'planet_name_simple': 'Moon', 'display_name': 'Moon', 'table_display_name': 'Moon (AK)', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '24:49:33', 'nakshatra': 'Purva Phalguni', 'pada': 4, 'rl': 'Su', 'nl': 'Ve', 'sl': 'Me', 'ssl': 'Ju', 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'AK', 'color': '#3B82F6'},
        {'name': 'Mars (DK)', 'planet_name_simple': 'Mars', 'display_name': 'Mars', 'table_display_name': 'Mars (DK)', 'sign': 'Taurus', 'sign_index': 2, 'house': 4, 'degree_formatted': '03:55:20', 'nakshatra': 'Krittika', 'pada': 3, 'rl': 'Ve', 'nl': 'Su', 'sl': 'Sa', 'ssl': 'Ve', 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'DK', 'color': '#DC2626'},
        {'name': 'Mercury (GK)', 'planet_name_simple': 'Mercury', 'display_name': 'Mercury', 'table_display_name': 'Mercury (GK)', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '04:04:15', 'nakshatra': 'Magha', 'pada': 2, 'rl': 'Su', 'nl': 'Ke', 'sl': 'Ju', 'ssl': 'Ra', 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'GK', 'color': '#16A34A'},
        {'name': 'Jupiter (MK)', 'planet_name_simple': 'Jupiter', 'display_name': 'Jupiter', 'table_display_name': 'Jupiter (MK)', 'sign': 'Taurus', 'sign_index': 2, 'house': 4, 'degree_formatted': '14:24:08', 'nakshatra': 'Rohini', 'pada': 2, 'rl': 'Ve', 'nl': 'Mo', 'sl': 'Ju', 'ssl': 'Sa', 'is_retrograde': false, 'status_marker': '(C)', 'is_combust': true, 'chara_karaka_code': 'MK', 'color': '#D97706'},
        {'name': 'Venus (PK)', 'planet_name_simple': 'Venus', 'display_name': 'Venus', 'table_display_name': 'Venus (PK)', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '07:33:45', 'nakshatra': 'Magha', 'pada': 3, 'rl': 'Su', 'nl': 'Ke', 'sl': 'Ra', 'ssl': 'Me', 'is_retrograde': false, 'status_marker': '', 'chara_karaka_code': 'PK', 'color': '#EC4899'},
        {'name': 'Saturn (BK)', 'planet_name_simple': 'Saturn', 'display_name': 'Saturn', 'table_display_name': 'Saturn (R)(BK)', 'sign': 'Pisces', 'sign_index': 12, 'house': 2, 'degree_formatted': '20:22:11', 'nakshatra': 'Revati', 'pada': 2, 'rl': 'Ju', 'nl': 'Me', 'sl': 'Ve', 'ssl': 'Ma', 'is_retrograde': true, 'status_marker': '(R)', 'chara_karaka_code': 'BK', 'color': '#6366F1'},
        {'name': 'Rahu', 'planet_name_simple': 'Rahu', 'display_name': 'Rahu', 'table_display_name': 'Rahu (R)', 'sign': 'Aquarius', 'sign_index': 11, 'house': 1, 'degree_formatted': '06:18:40', 'nakshatra': 'Shatabhisha', 'pada': 1, 'rl': 'Sa', 'nl': 'Ra', 'sl': 'Mo', 'ssl': 'Ju', 'is_retrograde': true, 'status_marker': '(R)', 'color': '#8B5CF6'},
        {'name': 'Ketu', 'planet_name_simple': 'Ketu', 'display_name': 'Ketu', 'table_display_name': 'Ketu (R)', 'sign': 'Leo', 'sign_index': 5, 'house': 7, 'degree_formatted': '06:18:40', 'nakshatra': 'Magha', 'pada': 3, 'rl': 'Su', 'nl': 'Ke', 'sl': 'Ra', 'ssl': 'Ve', 'is_retrograde': true, 'status_marker': '(R)', 'color': '#78716C'},
        {'name': 'Uranus', 'planet_name_simple': 'Uranus', 'display_name': 'Uranus', 'table_display_name': 'Uranus (R)', 'sign': 'Aquarius', 'sign_index': 11, 'house': 1, 'degree_formatted': '16:42:10', 'nakshatra': 'Purva Bhadra', 'pada': 1, 'rl': 'Sa', 'nl': 'Ju', 'sl': 'Me', 'ssl': 'Ra', 'is_retrograde': true, 'status_marker': '(R)', 'color': '#06B6D4'},
        {'name': 'Neptune', 'planet_name_simple': 'Neptune', 'display_name': 'Neptune', 'table_display_name': 'Neptune (R)', 'sign': 'Pisces', 'sign_index': 12, 'house': 2, 'degree_formatted': '28:15:30', 'nakshatra': 'Uttara Bhadra', 'pada': 4, 'rl': 'Ju', 'nl': 'Sa', 'sl': 'Ve', 'ssl': 'Me', 'is_retrograde': true, 'status_marker': '(R)', 'color': '#3B82F6'},
        {'name': 'Pluto', 'planet_name_simple': 'Pluto', 'display_name': 'Pluto', 'table_display_name': 'Pluto', 'sign': 'Capricorn', 'sign_index': 10, 'house': 12, 'degree_formatted': '01:50:22', 'nakshatra': 'Uttara Ashadha', 'pada': 2, 'rl': 'Sa', 'nl': 'Su', 'sl': 'Mo', 'ssl': 'Sa', 'is_retrograde': false, 'status_marker': '', 'color': '#8B5CF6'},
      ],
      'upagrahas': [
        {'name': 'Maandi', 'short_code': 'Md', 'degree_formatted': '18:12:33', 'sign': 'Aries', 'sign_sanskrit': 'Mesha', 'sign_index': 1, 'house': 3, 'nakshatra': 'Bharani', 'pada': 2, 'color': '#DC2626'},
        {'name': 'Gulika', 'short_code': 'Gk', 'degree_formatted': '06:17:00', 'sign': 'Pisces', 'sign_sanskrit': 'Meena', 'sign_index': 12, 'house': 2, 'nakshatra': 'Uttara Bhadra', 'pada': 1, 'color': '#EA580C'},
        {'name': 'Dhuma', 'short_code': 'Dh', 'degree_formatted': '05:08:49', 'sign': 'Sagittarius', 'sign_sanskrit': 'Dhanus', 'sign_index': 9, 'house': 11, 'nakshatra': 'Moola', 'pada': 2, 'color': '#64748B'},
        {'name': 'Vyatipata', 'short_code': 'Vy', 'degree_formatted': '24:51:10', 'sign': 'Cancer', 'sign_sanskrit': 'Karka', 'sign_index': 4, 'house': 6, 'nakshatra': 'Ashlesha', 'pada': 3, 'color': '#D97706'},
        {'name': 'Parivesha', 'short_code': 'Pv', 'degree_formatted': '24:51:10', 'sign': 'Capricorn', 'sign_sanskrit': 'Makara', 'sign_index': 10, 'house': 12, 'nakshatra': 'Dhanishta', 'pada': 1, 'color': '#0284C7'},
        {'name': 'Indrachapa', 'short_code': 'In', 'degree_formatted': '05:08:49', 'sign': 'Gemini', 'sign_sanskrit': 'Mithuna', 'sign_index': 3, 'house': 5, 'nakshatra': 'Mrigashira', 'pada': 4, 'color': '#7C3AED'},
        {'name': 'Upaketu', 'short_code': 'Uk', 'degree_formatted': '21:49:12', 'sign': 'Gemini', 'sign_sanskrit': 'Mithuna', 'sign_index': 3, 'house': 5, 'nakshatra': 'Punarvasu', 'pada': 1, 'color': '#9333EA'},
        {'name': 'Kaala', 'short_code': 'Kl', 'degree_formatted': '12:30:15', 'sign': 'Leo', 'sign_sanskrit': 'Simha', 'sign_index': 5, 'house': 7, 'nakshatra': 'Magha', 'pada': 4, 'color': '#475569'},
        {'name': 'Mrityu', 'short_code': 'Mr', 'degree_formatted': '19:45:00', 'sign': 'Virgo', 'sign_sanskrit': 'Kanya', 'sign_index': 6, 'house': 8, 'nakshatra': 'Hasta', 'pada': 3, 'color': '#B91C1C'},
        {'name': 'Ardhaprahara', 'short_code': 'Ap', 'degree_formatted': '28:10:40', 'sign': 'Capricorn', 'sign_sanskrit': 'Makara', 'sign_index': 10, 'house': 12, 'nakshatra': 'Dhanishta', 'pada': 2, 'color': '#059669'},
        {'name': 'Yamaghantaka', 'short_code': 'Yg', 'degree_formatted': '04:15:20', 'sign': 'Aquarius', 'sign_sanskrit': 'Kumbha', 'sign_index': 11, 'house': 1, 'nakshatra': 'Dhanishta', 'pada': 4, 'color': '#D97706'},
        {'name': 'Pranapada', 'short_code': 'Pp', 'degree_formatted': '16:22:18', 'sign': 'Libra', 'sign_sanskrit': 'Tula', 'sign_index': 7, 'house': 9, 'nakshatra': 'Swati', 'pada': 3, 'color': '#2563EB'},
      ],
      'arudha_padas': [
        {'code': 'AL (A1)', 'name': 'Arudha Lagna', 'house_number': 1, 'sign': 'Aquarius', 'sign_sanskrit': 'Kumbha', 'sign_index': 11, 'degree_formatted': '03:35:00', 'nakshatra': 'Dhanishta', 'pada': 4, 'significance': 'Image, Public Status & Manifested Self'},
        {'code': 'A2', 'name': 'Dhana Pada', 'house_number': 2, 'sign': 'Pisces', 'sign_sanskrit': 'Meena', 'sign_index': 12, 'degree_formatted': '20:22:11', 'nakshatra': 'Revati', 'pada': 2, 'significance': 'Wealth, Financial Assets & Family Resources'},
        {'code': 'A3', 'name': 'Bhratri Pada', 'house_number': 3, 'sign': 'Aries', 'sign_sanskrit': 'Mesha', 'sign_index': 1, 'degree_formatted': '03:55:20', 'nakshatra': 'Krittika', 'pada': 3, 'significance': 'Siblings, Courage & Enterprise'},
        {'code': 'A4', 'name': 'Matri / Sukha Pada', 'house_number': 4, 'sign': 'Taurus', 'sign_sanskrit': 'Vrishabha', 'sign_index': 2, 'degree_formatted': '07:33:45', 'nakshatra': 'Krittika', 'pada': 4, 'significance': 'Home, Vehicles & Inner Comforts'},
        {'code': 'A5', 'name': 'Putra / Mantra Pada', 'house_number': 5, 'sign': 'Gemini', 'sign_sanskrit': 'Mithuna', 'sign_index': 3, 'degree_formatted': '04:04:15', 'nakshatra': 'Mrigashira', 'pada': 4, 'significance': 'Progeny, Creativity & Intelligence'},
        {'code': 'A6', 'name': 'Shatru / Roga Pada', 'house_number': 6, 'sign': 'Cancer', 'sign_sanskrit': 'Karka', 'sign_index': 4, 'degree_formatted': '24:49:33', 'nakshatra': 'Ashlesha', 'pada': 3, 'significance': 'Debts, Diseases & Competition'},
        {'code': 'A7', 'name': 'Dara Pada', 'house_number': 7, 'sign': 'Leo', 'sign_sanskrit': 'Simha', 'sign_index': 5, 'degree_formatted': '07:33:45', 'nakshatra': 'Magha', 'pada': 3, 'significance': 'Spouse, Partnerships & Trade'},
        {'code': 'A8', 'name': 'Mrityu Pada', 'house_number': 8, 'sign': 'Virgo', 'sign_sanskrit': 'Kanya', 'sign_index': 6, 'degree_formatted': '03:55:20', 'nakshatra': 'Uttara Phalguni', 'pada': 3, 'significance': 'Longevity & Transformation'},
        {'code': 'A9', 'name': 'Bhagya Pada', 'house_number': 9, 'sign': 'Libra', 'sign_sanskrit': 'Tula', 'sign_index': 7, 'degree_formatted': '14:24:08', 'nakshatra': 'Swati', 'pada': 3, 'significance': 'Fortune, Dharma & Higher Wisdom'},
        {'code': 'A10', 'name': 'Rajya / Karma Pada', 'house_number': 10, 'sign': 'Scorpio', 'sign_sanskrit': 'Vrischika', 'sign_index': 8, 'degree_formatted': '20:22:11', 'nakshatra': 'Jyeshtha', 'pada': 2, 'significance': 'Career, Fame & Authority'},
        {'code': 'A11', 'name': 'Labha Pada', 'house_number': 11, 'sign': 'Sagittarius', 'sign_sanskrit': 'Dhanus', 'sign_index': 9, 'degree_formatted': '14:24:08', 'nakshatra': 'Purva Ashadha', 'pada': 1, 'significance': 'Gains & Networks'},
        {'code': 'UL (A12)', 'name': 'Upapada Lagna', 'house_number': 12, 'sign': 'Capricorn', 'sign_sanskrit': 'Makara', 'sign_index': 10, 'degree_formatted': '20:22:11', 'nakshatra': 'Shravana', 'pada': 4, 'significance': 'Marriage & Life Partner'},
      ],
      'special_lagnas': [
        {'name': 'Hora Lagna (HL)', 'sanskrit': 'Hora Lagna', 'sign': 'Leo', 'sign_sanskrit': 'Simha', 'sign_index': 5, 'degree_formatted': '21:10:00', 'nakshatra': 'Purva Phalguni', 'pada': 3, 'significance': 'Financial prosperity and liquid assets.'},
        {'name': 'Ghati Lagna (GL)', 'sanskrit': 'Ghati Lagna', 'sign': 'Scorpio', 'sign_sanskrit': 'Vrischika', 'sign_index': 8, 'degree_formatted': '08:45:00', 'nakshatra': 'Anuradha', 'pada': 2, 'significance': 'Power, authority and public renown.'},
        {'name': 'Bhava Lagna (BL)', 'sanskrit': 'Bhava Lagna', 'sign': 'Cancer', 'sign_sanskrit': 'Karka', 'sign_index': 4, 'degree_formatted': '12:15:00', 'nakshatra': 'Pushya', 'pada': 3, 'significance': 'Vitality and physical strength.'},
        {'name': 'Sree Lagna (SL)', 'sanskrit': 'Sree Lagna', 'sign': 'Taurus', 'sign_sanskrit': 'Vrishabha', 'sign_index': 2, 'degree_formatted': '18:50:00', 'nakshatra': 'Rohini', 'pada': 3, 'significance': 'Goddess Lakshmi grace and sustained wealth.'},
        {'name': 'Indu Lagna (IL)', 'sanskrit': 'Indu Lagna', 'sign': 'Aries', 'sign_sanskrit': 'Mesha', 'sign_index': 1, 'degree_formatted': '15:20:00', 'nakshatra': 'Bharani', 'pada': 1, 'significance': 'Financial windfalls and business prosperity.'},
      ],
      'chara_karakas': [
        {'planet': 'Moon', 'karaka_code': 'AK', 'karaka_name': 'Atmakaraka', 'significance': 'Soul / Destiny / King', 'degree_in_sign': '24:49:33', 'sign': 'Leo', 'nakshatra': 'Purva Phalguni', 'pada': 4},
        {'planet': 'Sun', 'karaka_code': 'AmK', 'karaka_name': 'Amatyakaraka', 'significance': 'Career / Profession / Minister', 'degree_in_sign': '21:49:12', 'sign': 'Cancer', 'nakshatra': 'Ashlesha', 'pada': 2},
        {'planet': 'Saturn', 'karaka_code': 'BK', 'karaka_name': 'Bhratrikaraka', 'significance': 'Siblings / Courage / Guru', 'degree_in_sign': '20:22:11', 'sign': 'Pisces', 'nakshatra': 'Revati', 'pada': 2},
        {'planet': 'Jupiter', 'karaka_code': 'MK', 'karaka_name': 'Matrikaraka', 'significance': 'Mother / Inner Peace / Home', 'degree_in_sign': '14:24:08', 'sign': 'Taurus', 'nakshatra': 'Rohini', 'pada': 2},
        {'planet': 'Venus', 'karaka_code': 'PK', 'karaka_name': 'Putrakaraka', 'significance': 'Children / Intelligence / Creativity', 'degree_in_sign': '07:33:45', 'sign': 'Leo', 'nakshatra': 'Magha', 'pada': 3},
        {'planet': 'Mercury', 'karaka_code': 'GK', 'karaka_name': 'Gnatikaraka', 'significance': 'Obstacles / Health / Competitors', 'degree_in_sign': '04:04:15', 'sign': 'Leo', 'nakshatra': 'Magha', 'pada': 2},
        {'planet': 'Mars', 'karaka_code': 'DK', 'karaka_name': 'Darakaraka', 'significance': 'Spouse / Partner / Relations', 'degree_in_sign': '03:55:20', 'sign': 'Taurus', 'nakshatra': 'Krittika', 'pada': 3},
      ],
      'houses': {
        '1': ['Ascendant', 'Rahu'],
        '2': ['Saturn'],
